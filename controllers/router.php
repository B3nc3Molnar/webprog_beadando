...
session_start();
//Ha a sessionben még nincs userid beállítva, akkor alapértelmezett értékként 0-t kap. Ez azt jelenti, hogy nincs bejelentkezett felhasználó.
if(! isset($_SESSION['userid'])) $_SESSION['userid'] = 0;
//Ha nincs beállítva a felhasználó keresztneve, akkor egy üres  ("") állít be.
if(! isset($_SESSION['userfirstname'])) $_SESSION['userfirstname'] = "";
// Ha nincs beállítva a felhasználó vezetékneve, akkor szintén egy üres  ("") állít be.
if(! isset($_SESSION['userlastname'])) $_SESSION['userlastname'] = "";
// Ha nincs beállítva a felhasználó jogosultsági szintje (felhasználói szint), akkor alapértelmezésként "__"-t állít be.
